    ...
    <section>
        ...
        <div className="bg-white rounded-lg shadow-xl pb-8">
            ...
            <div className="w-full h-[250px]">
                {/* <Image className="w-full h-full rounded-tl-lg rounded-tr-lg" width={200} height={200} > */}
            </div>
            <div className="flex flex-col items-center -mt-20"> 
                {/* <Image className="w-40 border-4 border-white rounded-full" width={200} height={200} > */}
